 ...
 * @param boolead $show_admin Include or not company_id == 0 in condition (used in the MultiVendor Edition)
...
function fn_get_company_condition($db_field = 'company_id', $add_and = true, $company = '', $show_admin = false, $force_condition_for_area_c = false)
{
	...
	if (PRODUCT_TYPE == 'ULTIMATE' && defined('COMPANY_ID') && (empty($company) || $company == 0)) {
		$company = COMPANY_ID;
	}
...
function fn_get_default_company_id($null = '')
{
