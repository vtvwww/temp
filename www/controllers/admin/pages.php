...
if ($mode == 'update' || $mode == 'add') {	
	...
	if ($mode == "update") {
		...
		$breadcrumb_link = !empty($_REQUEST['come_from']) ? '&page_type=' . $_REQUEST['come_from'] : '';
	...
	if (!empty($_REQUEST['page_data']['company_id'])) {
	...
	} elseif (empty($page_data['company_id']) && PRODUCT_TYPE == 'ULTIMATE') {
