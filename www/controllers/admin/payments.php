...
{
	// FIXME: Payments must have owner company. Getting templates from first found company is very bad idea.
	if (defined('COMPANY_ID') || PRODUCT_TYPE == 'ULTIMATE') {
		$company_id = defined('COMPANY_ID') ? COMPANY_ID : fn_get_default_company_id();
