...
if ($mode == 'delete') {
	...
	if (!empty($section_data['owner_object']['name_function']) && function_exists($section_data['owner_object']['name_function'])) {
		$view->assign('owner_object_name', $section_data['owner_object']['name_function']($_REQUEST[$section_data['owner_object']['key']]));
	}
	...
	if (!empty($section_data['owner_object']['return_url']) && !empty($section_data['owner_object']['return_url_text'])) {
		$view->assign('breadcrumbs', array(array('link' => $section_data['owner_object']['return_url'], 'title' =>fn_get_lang_var($section_data['owner_object']['return_url_text'])) ));
	}
}
