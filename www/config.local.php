...
$config['db_name'] = 'unscscart';
$config['db_user'] = 'uns_db';
$config['db_password'] = 'yrhveXtSVQaypKxA';
...
$config['admin_index'] = 'ua.php';//'admin.php';
$config['customer_index'] = 'index.php';
$config['vendor_index'] = 'u.php';//'vendor.php';
