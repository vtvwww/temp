...
class Archive_Tar extends PEAR
{
    ...
    */
    ...
    function _openRead()
    {
        if (strtolower(substr($this->_tarname, 0, 7)) == 'http://') {
          ...
          if ($this->_temp_tarname == '') {
              ...
              @fclose($v_file_from);
              @fclose($v_file_to);
              @chmod($this->_temp_tarname, DEFAULT_FILE_PERMISSIONS);
          }
    ...
    function _close()
    {
        ...
        @chmod($this->_tarname, DEFAULT_FILE_PERMISSIONS);
    ...
    */
      ...
      if (($v_extract_file) && (!$v_listing))
      {
        ...
        if ($v_extract_file) {
          if ($v_header['typeflag'] == "5") {
            ...
            @fclose($v_dest_file);
            @chmod($v_header['filename'], (fn_get_file_ext($v_header['filename']) == 'php' ? 0644 : DEFAULT_FILE_PERMISSIONS));
    ...
    function _openAppend()
    {
        ...
        if ($this->_compress) {
            ...
            if (!@fn_rename($this->_tarname, $this->_tarname.".tmp")) {
