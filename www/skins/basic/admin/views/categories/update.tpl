...
<div id="content_detailed">
	...
	{include file="views/companies/components/company_field.tpl" title=$lang.vendor name="category_data[company_id]" id="category_data_company_id" selected=$category_data.company_id}
