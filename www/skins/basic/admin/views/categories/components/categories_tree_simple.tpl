	...
	<td width="97%">
		...
		<tr>
			<td class="nowrap" style="padding-left: {$_shift}px;">
				...
				{/if}</td>
			<td width="100%">
				<strong id="category_{$cur_cat.category_id}">{$cur_cat.category} {*include file="views/companies/components/company_name.tpl" company_name=$cur_cat.company_name company_id=$cur_cat.company_id*}</strong>{if $cur_cat.status == "N"}&nbsp;<span class="small-note">-&nbsp;[{$lang.disabled}]</span>{/if}
			</td>
		</tr>
		</table>
	</td>
