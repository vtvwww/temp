...
{hook name="companies:product_details_fields"}
	...
	{include file="views/companies/components/company_field.tpl" title=$lang.vendor name="product_data[company_id]" id="product_data_company_id" selected=$product_data.company_id tooltip=$lang.text_ult_product_store_field_tooltip reload_form=$reload_form}
...
<fieldset>
	...
	{include file="common_templates/sortable_position_scripts.tpl" sortable_table="images_links" sortable_id_name="pair_id" handle_class="cm-sortable-handle"}
