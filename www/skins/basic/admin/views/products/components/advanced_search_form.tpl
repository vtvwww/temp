...
{foreach from=$filters_row item="filter"}
	<td width="33%">
		...
		{elseif $filter.feature_type == "O" || $filter.feature_type == "N" && $filter.filter_id || $filter.feature_type == "D" || $filter.condition_type == "D" || $filter.condition_type == "F"}
			{if $filter.feature_type == "N" && $filter.filter_id || $filter.condition_type == "D" || $filter.condition_type == "F"}<div class="scroll-y">{/if}
				...
				{if !$filter.slider}
					...
					{/foreach}
				{/if}
			{if $filter.feature_type == "N" && $filter.filter_id || $filter.condition_type == "D" || $filter.condition_type == "F"}</div>{/if}
