...
<tr {if $page.level > 0 && !$search.paginate}class="multiple-table-row"{/if}>
	...
	<td class="nowrap">
		...
		<li>
			...
			<a class="cm-confirm" href="{"pages.delete?page_type=`$page.page_type`&amp;page_id=`$page.page_id``$multi_level`"|fn_url}">
