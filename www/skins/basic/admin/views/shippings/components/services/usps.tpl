...
<div class="form-field">
	...
	<div class="table-filters">
		<div class="scroll-y">
			...
			<div class="select-field">
				<input type="hidden" name="shipping_data[params][intl_service_restricted_delivery]" value="N" />
				<input type="checkbox" {if $shipping.params.intl_service_restricted_delivery == "Y"}checked="checked"{/if} value="Y" name="shipping_data[params][intl_service_restricted_delivery]" id="intl_service_restricted_delivery" class="checkbox"><label for="intl_service_restricted_delivery">{$lang.usps_service_restricted_delivery}</label>
			</div>
			<div class="select-field">
...
<div class="form-field">
	...
	<div class="table-filters">
		<div class="scroll-y">
			...
			<div class="select-field">
				<input type="hidden" name="shipping_data[params][domestic_service_restricted_delivery]" value="N" />
				<input type="checkbox" {if $shipping.params.domestic_service_restricted_delivery == "Y"}checked="checked"{/if} value="Y" name="shipping_data[params][domestic_service_restricted_delivery]" id="domestic_service_restricted_delivery" class="checkbox"><label for="domestic_service_restricted_delivery">{$lang.usps_service_restricted_delivery}</label>
			</div>
			<div class="select-field">
