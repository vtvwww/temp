...
<tr class="table-row">
	...
	<td>
		{if $customer.firstname || $customer.lastname}<a href="{"profiles.update?user_id=`$customer.user_id`"|fn_url}" class="underlined">{$customer.lastname} {$customer.firstname}</a>{else}{$lang.unregistered_customer}{/if}
	</td>
