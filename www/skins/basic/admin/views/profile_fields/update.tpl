...
<div class="cm-tabs-content">
	<div id="content_tab_new_profile{$id}">
		...
		<div class="form-field">
			...
			<select id="elm_field_section" name="field_data[section]" {if $id}disabled="disabled"{/if}>
				<option value="C" {if $field.section == "C"}selected="selected"{/if}>{$lang.contact_information}</option>
				<option value="BS" {if $field.section == "B" || $field.section == "S"}selected="selected"{/if}>{$lang.billing_address}/{$lang.shipping_address}</option>
			</select>
			{if $id}
		...
		<div class="form-field">
			...
			<input type="hidden" name="field_data[{$_show}]" value="N" />
			<input type="checkbox" name="field_data[{$_show}]" value="Y" {if $field.$_show == "Y"}checked="checked"{/if} />&nbsp;
			<input type="hidden" name="field_data[{$_required}]" value="N" />
			<input type="checkbox" name="field_data[{$_required}]" value="Y" {if $field.$_required == "Y"}checked="checked"{/if} />
		</div>
		{/foreach}
