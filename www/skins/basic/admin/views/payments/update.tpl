...
<form action="{""|fn_url}" method="post" name="payments_form_{$id}" enctype="multipart/form-data" class="cm-form-highlight {if !""|fn_allow_save_object:"payments"}cm-hide-inputs{/if}">
