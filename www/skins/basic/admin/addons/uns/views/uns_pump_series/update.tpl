            ...
            {capture name="tabsbox"}
                <div id="content_general">
                    ...
                    {include file="addons/uns/views/components/get_form_field.tpl"
                        ...
                        f_plus_minus=true
                        f_tooltip="Минимальное значение партии насосов для расчета плана производства насосов для механического цеха и расчета плана производства отливок для литейного цеха.<br>Например, если МИН=10, МАКС=22, ШАГ=3, по расчетам необходимо изготовить 7 насосов, тогда размер партии равен: 10. Если по расчетам необходимо изготовить 11 насосов, тогда размер партии равен: МИН+ШАГ = 10+3 = 13. <br><br><b>План производства насосов</b><br><img src='skins/basic/admin/images/tooltips/pump_series_party_sizes.png'>"
                    }
                    {include file="addons/uns/views/components/get_form_field.tpl"
                        f_type="select_range"
                        f_id="party_size_max"
                        ...
                        f_plus_minus=true
                        f_tooltip="Максимальное значение партии насосов для расчета плана производства насосов для механического цеха и расчета плана производства отливок для литейного цеха.<br>Например, если МИН=10, МАКС=22, ШАГ=3, по расчетам необходимо изготовить 7 насосов, тогда размер партии равен: 10. Если по расчетам необходимо изготовить 11 насосов, тогда размер партии равен: МИН+ШАГ = 10+3 = 13. <br><br><b>План производства насосов</b><br><img src='skins/basic/admin/images/tooltips/pump_series_party_sizes.png'>"
                    }
                    {include file="addons/uns/views/components/get_form_field.tpl"
                        f_type="select_range"
                        ...
                        f_plus_minus=true
                        f_tooltip="Шаг увеличения значения партии насосов от минимального до максимального.<br>Например, если МИН=10, МАКС=22, ШАГ=3, по расчетам необходимо изготовить 7 насосов, тогда размер партии равен: 10. Если по расчетам необходимо изготовить 11 насосов, тогда размер партии равен: МИН+ШАГ = 10+3 = 13. <br><br><b>План производства насосов</b><br><img src='skins/basic/admin/images/tooltips/pump_series_party_sizes.png'>"
                    }
