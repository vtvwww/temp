...
{elseif $f_type == "item_type"}
    {if $f_simple}
        <select name="{$f_name}" {if $f_id} id="{$f_id}" {/if} {if $f_disabled}disabled="disabled"{/if} >
            ...
            {if $f_detail}      <option {if $f_value == "D"}  selected="selected" {/if} {if $f_disabled_detail}     disabled="disabled" {/if} value="D">{if $f_short}Д{else}Дет.{/if}</option>{/if}
            {if $f_material}    <option {if $f_value == "M"}  selected="selected" {/if} {if $f_disabled_material}   disabled="disabled" {/if} value="M">{if $f_short}М{else}Мат.{/if}</option>{/if}
            {if $f_p}           <option {if $f_value == "P"}  selected="selected" {/if} {if $f_disabled_p}          disabled="disabled" {/if} value="P">{if $f_short}Н{else}Насос{/if}</option>{/if}
            {if $f_pf}          <option {if $f_value == "PF"} selected="selected" {/if} {if $f_disabled_pf}         disabled="disabled" {/if} value="PF">{if $f_short}НР{else}Н на раме{/if}</option>{/if}
            {if $f_pa}          <option {if $f_value == "PA"} selected="selected" {/if} {if $f_disabled_pa}         disabled="disabled" {/if} value="PA">{if $f_short}НА{else}Н агрегат{/if}</option>{/if}
        </select>
    {else}
    {/if}
