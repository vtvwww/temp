...
{capture name="mainbox"}
    {include file="addons/uns_orders/views/uns_plans/components/search_form.tpl" dispatch="`$controller`.manage" search_content=$smarty.capture.search_content}
...
{/capture}
{include file="common_templates/mainbox.tpl" title="Планы производства" content=$smarty.capture.mainbox tools=$smarty.capture.tools}
