...
{capture name="mainbox"}
   {*{include file="addons/uns_mech/views/uns_moving_stores/components/info.tpl"}*}
   {include file="addons/uns_mech/views/uns_moving_stores/components/search.tpl" dispatch="`$controller`.manage"}
...
{/capture}
{include file="common_templates/mainbox.tpl" title="Движения по Складу Метизов и Подшипников" content=$smarty.capture.mainbox tools=$smarty.capture.tools}
