...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table sortable">
	...
	<tr {cycle values="class=\"table-row\", "}>
		...
		<td>
			...
			{include file="common_templates/select_popup.tpl" id="`$ug_request.usergroup_id`_`$ug_request.user_id`" status=$ug_request.status hidden="" items_status="A: \"`$lang_active`\", P: \"`$lang_pending`\", F: \"`$lang_available`\", D: \"`$lang_declined`\"" extra="&amp;user_id=`$ug_request.user_id`" update_controller="usergroups" notify=true}
		</td>
	</tr>
	{foreachelse}
	<tr class="no-items">
