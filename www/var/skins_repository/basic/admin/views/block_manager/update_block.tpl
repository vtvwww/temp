...
<div id="block_properties_{$html_id}">
	...
	<div class="tabs cm-j-tabs">
		<ul>
			...
			{if $smarty.capture.block_content}<li id="block_content_{$html_id}" class="cm-js{if $active_tab == "block_content_`$html_id`"} cm-active{/if}"><a>{$lang.content}</a></li>{/if}
	...
	<div class="cm-tabs-content" id="tabs_content_block_{$html_id}">
		...
		{if $smarty.capture.block_content}
			<div id="content_block_content_{$html_id}" >
				<fieldset>
	...
	<div class="buttons-container">
		...
		{elseif $smarty.request.force_close}
			{include file="buttons/save_cancel.tpl" but_name="dispatch[block_manager.update_block]" cancel_action="close" but_meta="cm-dialog-closer"}
		{else}
