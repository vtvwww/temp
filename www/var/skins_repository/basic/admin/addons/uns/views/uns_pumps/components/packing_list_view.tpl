                    ...
                    {foreach from=$v_pl item='i'}
                        ...
                        {if $i.replacement.pplr_type != "D"}
                            ...
                            <tr>
                                ...
                                <td><span style="font-weight: bold;">{$item_name}</span>{$sup}{if $item_no}{if $typesize}{$typesize}{/if}<span style="font-weight: normal; font-size: 10px;"><br>{$item_no}</span>{/if}</td>
                                ...
                                <td>{if $item_type == "D"}{$material_name}{/if}</td>
