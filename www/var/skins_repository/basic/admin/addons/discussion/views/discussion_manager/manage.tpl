...
<form action="{""|fn_url}" method="POST" name="update_posts_form_{$object_type|lower}">
<input type="hidden" name="redirect_url" value="discussion_manager.manage&amp;selected_section={$discussion_object_types.$object_type}">
{include file="common_templates/pagination.tpl" save_current_page=true save_current_url=true div_id="pagination_contents_`$object_type`"}
...
{include file="common_templates/pagination.tpl" div_id="pagination_contents_`$object_type`"}
...
<div class="buttons-container buttons-bg">
		...
		<ul>
			<li><a name="dispatch[discussion.delete]" class="cm-process-items-{$object_type|lower} cm-confirm" rev="update_posts_form_{$object_type|lower}">{$lang.delete_selected}</a></li>
		</ul>
		{/capture}
