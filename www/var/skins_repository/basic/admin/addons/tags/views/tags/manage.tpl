...
{foreach from=$tags item="tag"}
	<tr {cycle values="class=\"table-row\", "}>
		...
		<td>
			...
			{include file="common_templates/select_popup.tpl" id=$tag.tag_id status=$tag.status items_status="A: \"`$lang_approved`\", D: \"`$lang_disapproved`\", P: \"`$lang_pending`\"" object_id_name="tag_id" table="tags"}
		</td>
		<td class="nowrap">
