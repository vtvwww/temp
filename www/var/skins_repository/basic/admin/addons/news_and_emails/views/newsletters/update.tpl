...
{include file="common_templates/select_status.tpl" input_name="newsletter_data[status]" id="newsletter_data" obj=$newsletter items_status="A: \"`$lang_active`\", D: \"`$lang_disabled`\", S: \"`$lang_sent`\""}
