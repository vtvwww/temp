...
<fieldset>
	...
	<div class="form-field">
		...
		<input type="text" name="mailing_list_data[from_email]" id="elm_from_email_{$id}" value="{$mailing_list.from_email}" class="input-text" />
	</div>

	<div class="form-field">
		<label for="elm_reply_to_{$id}">{$lang.reply_to}:</label>
		<input type="text" name="mailing_list_data[reply_to]" id="elm_reply_to_{$id}" value="{$mailing_list.reply_to}" class="input-text" />
	</div>
	...
	<div class="form-field">
		...
		<input type="hidden" name="mailing_list_data[show_on_sidebar]" value="0" />
		<input type="checkbox" name="mailing_list_data[show_on_sidebar]" id="elm_show_on_sidebar_{$id}" value="1" {if $mailing_list.show_on_sidebar}checked="checked"{/if} class="checkbox" />
	</div>
