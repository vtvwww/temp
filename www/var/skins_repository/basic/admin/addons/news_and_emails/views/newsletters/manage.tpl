...
<tr {cycle values="class=\"table-row\", "}>
	...
	{if $newsletter_type == $smarty.const.NEWSLETTER_TYPE_NEWSLETTER}
		{*<td>
			...
			{assign var="lang_sent" value=$lang.sent|escape:dquotes}

			{include file="common_templates/select_popup.tpl" id=$newsletter.newsletter_id status=$newsletter.status items_status="A: \"`$lang_active`\", D: \"`$lang_disabled`\", S: \"`$lang_sent`\"" object_id_name="newsletter_id" table="newsletters"}
		</td>*}
