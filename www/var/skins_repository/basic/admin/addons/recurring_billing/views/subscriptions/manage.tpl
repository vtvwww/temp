...
<tr {cycle values="class=\"table-row\", "}>
	...
	<td>
		...
		{assign var="lang_rb_unsubscribed" value=$lang.rb_unsubscribed|escape:dquotes}
		{assign var="lang_completed" value=$lang.completed|escape:dquotes}
		{include file="common_templates/select_popup.tpl" id=$sub.subscription_id status=$sub.status items_status="A: \"`$lang_active`\", D: \"`$lang_disabled`\", U: \"`$lang_rb_unsubscribed`\", C: \"`$lang_completed`\"" update_controller="subscriptions" notify=true}
	</td>
	<td class="nowrap">
