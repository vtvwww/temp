...
<tr {cycle values="class=\"table-row\", "}>
	...
	<td>
		...
		{include file="common_templates/select_popup.tpl" id=$payout_id status=$payout.status items_status="O: \"`$lang_open`\", S: \"`$lang_successful`\"" object_id_name="payout_id" table="affiliate_payouts"}
	</td>
	<td class="nowrap">
