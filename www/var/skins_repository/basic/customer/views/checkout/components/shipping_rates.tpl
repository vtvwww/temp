...
{/literal}
	...
	{else}{* $settings.Suppliers.display_shipping_methods_separately != "Y"  OR Suppliers disabled*}
		...
		<div class="overflow-hidden{if $display == "select"} form-field shipping-rates{elseif $display == "radio"} shipping-rates-radio{/if}" id="shipping_rates_list" class="shipping-options">
		{if $display == "radio"}
