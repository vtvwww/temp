<ul class="statistic-list">
	...
	<li>
		<span class="checkout-item-title">{$lang.coupon} "{$coupon_code}"
		...
		{include file="buttons/button.tpl" but_href="checkout.delete_coupon?coupon_code=`$coupon_code`&redirect_url=`$_redirect_url`" but_role="delete" but_meta="delete-icon" but_rev="checkout_totals,cart_items,cart_status*,checkout_steps,checkout_cart"}{/if}</span>
		<span class="checkout-item-value">&nbsp;</span>
	</li>
	{/foreach}
	{/if}
