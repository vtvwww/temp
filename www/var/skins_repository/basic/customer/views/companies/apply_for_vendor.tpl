...
{if !$auth.user_id}
	{include file="views/profiles/components/profile_fields.tpl" section="C" title=$lang.contact_information disabled_by_default=true}
{else}
...
{if !$auth.user_id}
	{include file="views/profiles/components/profile_fields.tpl" section="B" title=$lang.shipping_address shipping_flag=false disabled_by_default=true}
{else}
