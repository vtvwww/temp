...
<div id="content_product_more_filters_{$block.block_id}_{$filter.filter_id}" class="price-slider hidden">
	...
	<div id="{$id}" class="cm-range-slider">	<ul>
	...
	<input type="hidden" id="{$id}_json" value='{ldelim}
		...
		"ajax": {if $use_ajax}true{else}false{/if},
