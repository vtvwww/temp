									...
									<td style="padding-left: 5px">
										...
										<div style="margin: 12px 0px 0px 10px;">
											...
											<table border="0" cellpadding="10" cellspacing="10">
												...
												<tr valign="top">
													<td><span style="color: #ffffff; line-height: 20px; font-weight: bold">{$product.amount}</span>&nbsp;</td><td><a href="{"products.view?product_id=`$product.product_id`"|fn_url:'C':'http':'&'}" class="product-link" style="color: #ffffff; line-height: 20px;">{$product.product}</a><br />
								...
								<tr>
									<td background="{$images_dir}/gift_m.png" style="background-repeat: no-repeat; height: 52px;">
										<div style="text-align: right;color: #ffffff; padding: 30px 5px 5px 0px">
											<b>{$lang.shop_now}:</b>&nbsp;<a href="{$config.http_location|fn_url:'C'}" target="_blank" class="action-text-button" style="white-space: nowrap; margin-right: 1px; text-decoration: underline; padding: 2px 5px 2px 0px; color: #ffffff;">{$config.http_location|fn_url:'C'}</a>
										</div>
									</td>
								</tr>
							</table>
