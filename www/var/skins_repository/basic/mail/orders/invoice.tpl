		...
		<td style="background-color: #ffffff; border: 1px solid #e6e6e6; margin: 0px auto 0px auto; padding: 0px 44px 0px 46px; text-align: left;">
			...
			<tr valign="top">
				...
				<td width="33%" style="font-size: 12px; font-family: Arial;">
					...
					<p style="margin: 2px 0px 3px 0px;">{if $profields_c.title && $order_info.title}{$order_info.title}. {/if}{if $profields_c.firstname}{$order_info.firstname}&nbsp;{/if}{if $profields_c.lastname}{$order_info.lastname}{/if}</p>
