...
<tr>
	...
	<td width="600" style="border: #444444; border-style: solid; border-width: 2px" align="center">
		...
		<tr>
			...
			<table>
			<tr>
				<td align="right" nowrap="nowrap"><b>{$lang.shipping_method}:</b>&nbsp;</td>
				<td align="right" nowrap="nowrap">{$supplier_shipping.shipping}</td>
			</tr>
			</table>
			</div>
			...
			<tr>
				...
				<td align="right" nowrap="nowrap">{include file="common_templates/price.tpl" value=$supplier_shipping.cost}</td>
			</tr>
			</table><br />
			</div>
			{/if}
